...
Or run the test suite directly from Xcode with `⌘U`. Tests live in `Tests/` and cover the generator, text-replacement engine, workday calculation, update checker, and supporting helpers.
